...
if redis:get(basha..':lock_Add_User:'..msg.chat_id_) then 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.." \n📡*¦* الاضافه عبر الرابط بالفعل مقفله \n✓" 
else 
redis:set(basha..':lock_Add_User:'..msg.chat_id_,true)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(basha..':lock_Add_User:'..msg.chat_id_) then 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.." \n📡*¦* الاضافه بالفعل مفتوحه \n✓" 
else
redis:del(basha..':lock_Add_User:'..msg.chat_id_) 
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المدير,المنشئ,المطور} فقط  \n🚶" end
if redis:get(basha..':lock_id_photo:'..msg.chat_id_) then 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.." \n📡*¦* الايدي بالصوره معطل مسبقا \n✓" 
else 
redis:set(basha..':lock_id_photo:'..msg.chat_id_,true)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(basha..':lock_id_photo:'..msg.chat_id_) then 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.." \n📡*¦* الايدي بالصوره مفعل مسبقا \n✓" 
else
redis:del(basha..':lock_id_photo:'..msg.chat_id_) 
...
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.." \n📡*¦* التحذير مفعل مسبقاً \n✓" 
else redis:set(basha..'lock_woring'..msg.chat_id_,true)
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم تفعيل التحذير \n✓" 
end
end
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(basha..'lock_woring'..msg.chat_id_) then 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* التحذير بالتأكيد معطل\n✓" 
else
redis:del(basha..'lock_woring'..msg.chat_id_) 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم تعطيل التحذير \n✓" 
end 
end
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(basha..'lock_id'..msg.chat_id_) then 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* الايدي بالتأكيد معطل\n✓" 
else
redis:del(basha..'lock_id'..msg.chat_id_) 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم تعطيل امر الايدي\n✓" 
end 
end
...
redis:set(basha..'lock_id'..msg.chat_id_,true)  
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم تفعيل امر الايدي \n✓" 
end 
end
...
else redis:set(basha..'welcome:get'..msg.chat_id_,true)  
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم تفعيل الترحيب \n✓" 
end 
end
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(basha..'welcome:get'..msg.chat_id_) then 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:mset(
basha..'lock_username'..msg.chat_id_,true,
basha..'mute_gif'..msg.chat_id_,true,
basha..'mute_photo'..msg.chat_id_,true,
basha..'mute_audio'..msg.chat_id_,true,
basha..'mute_voice'..msg.chat_id_,true,
basha..'mute_sticker'..msg.chat_id_,true,
basha..'mute_forward'..msg.chat_id_,true,
basha..'mute_contact'..msg.chat_id_,true,
basha..'mute_location'..msg.chat_id_,true,
basha..'mute_document'..msg.chat_id_,true,
basha..'lock_link'..msg.chat_id_,true,
basha..'lock_tag'..msg.chat_id_,true,
basha..'lock_edit'..msg.chat_id_,true,
basha..'lock_spam'..msg.chat_id_,true,
basha..'lock_bots'..msg.chat_id_,true,
basha..'lock_webpage'..msg.chat_id_,true,
basha..'mute_video'..msg.chat_id_,true,
basha..'mute_inline'..msg.chat_id_,true
)
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم قفل الكل  \n✓"
end
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:del(
basha..'lock_username'..msg.chat_id_,
basha..'mute_gif'..msg.chat_id_,
basha..'mute_photo'..msg.chat_id_,
basha..'mute_audio'..msg.chat_id_,
basha..'mute_voice'..msg.chat_id_,
basha..'mute_sticker'..msg.chat_id_,
basha..'mute_forward'..msg.chat_id_,
basha..'mute_contact'..msg.chat_id_,
basha..'mute_location'..msg.chat_id_,
basha..'mute_document'..msg.chat_id_,
basha..'lock_link'..msg.chat_id_,
basha..'lock_tag'..msg.chat_id_,
basha..'lock_edit'..msg.chat_id_,
basha..'lock_spam'..msg.chat_id_,
basha..'lock_bots'..msg.chat_id_,
basha..'lock_webpage'..msg.chat_id_,
basha..'mute_video'..msg.chat_id_,
basha..':tqeed_video:'..msg.chat_id_,
basha..':tqeed_photo:'..msg.chat_id_,
basha..':tqeed_gif:'..msg.chat_id_,
basha..':tqeed_fwd:'..msg.chat_id_,
basha..':tqeed_link:'..msg.chat_id_,
basha..'mute_inline'..msg.chat_id_
)
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم فتح الكل  \n✓"
end
...
if redis:get(basha..':tqeed_photo:'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التقييد بالصور بالتأكيد تم قفله \n✓'
else
redis:del(basha..'mute_photo'..msg.chat_id_)
redis:set(basha..':tqeed_photo:'..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if not redis:get(basha..':tqeed_photo:'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التقييد بالصور بالتأكيد تم فتحه \n✓'
else 
redis:del(basha..':tqeed_photo:'..msg.chat_id_)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(basha..':tqeed_video:'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التقييد بالفيديو بالتأكيد تم قفله \n✓'
else
redis:del(basha..':tqeed_video:'..msg.chat_id_)
redis:set(basha..':tqeed_video:'..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if not redis:get(basha..':tqeed_video:'..msg.chat_id_) then
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(basha..':tqeed_gif:'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التقييد الممتحركه بالتأكيد تم قفله \n✓'
else
redis:del(basha..'mute_gif'..msg.chat_id_)
redis:set(basha..':tqeed_gif:'..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if not redis:get(basha..':tqeed_gif:'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التقييد المتحركه بالتأكيد تم فتحه \n✓'
else 
redis:del(basha..':tqeed_gif:'..msg.chat_id_)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(basha..':tqeed_fwd:'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التقييد بالتوجيه بالتأكيد تم قفله \n✓'
else
redis:del(basha..'mute_forward'..msg.chat_id_)
redis:set(basha..':tqeed_fwd:'..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if not redis:get(basha..':tqeed_fwd:'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التقييد التوجيه بالتأكيد تم فتحه \n✓'
else 
redis:del(basha..':tqeed_fwd:'..msg.chat_id_)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(basha..':tqeed_link:'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التقييد بالروابط بالتأكيد تم قفله \n✓'
else
redis:set(basha..':tqeed_link:'..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if not redis:get(basha..':tqeed_link:'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التقييد بالروابط بالتأكيد تم فتحه \n✓'
else 
redis:del(basha..':tqeed_link:'..msg.chat_id_)
...
if not redis:get(basha..'replay'..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'replay'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الردود بالتاكيد تم تفعيله \n✓'
else 
redis:set(basha..'replay'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم تفعيل الردود  \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'lock_link'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الروابط بالتأكيد تم قفلها \n✓'
else
redis:set(basha..'lock_link'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل الروابط \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'lock_link'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الروابط بالتأكيد تم فتحها \n✓'
else 
redis:del(basha..'lock_link'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح الروابط \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'lock_tag'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التاك (#) بالتأكيد تم قفله \n✓'
else
redis:set(basha..'lock_tag'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل التاك (#) \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'lock_tag'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التاك(#) بالتأكيد تم فتحه \n✓'
else 
redis:del(basha..'lock_tag'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح التاك (#) \n✓'
end
end
---------------Lock UserName-------------------
...
if redis:get(basha..'lock_username'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* المعرفات @ بالتأكيد تم قفله \n✓'
else
redis:set(basha..'lock_username'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل المعرفات @ \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'lock_username'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* آلمـعرفآت بآلتآگيد تم فتحهآ @ \n✓'
else 
redis:del(basha..'lock_username'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح آلمـعرفآت @ \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'lock_edit'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التعديل بالتأكيد تم قفله \n✓'
else
redis:del(basha..'lock_edit'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل التعديل \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'lock_edit'..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if   redis:get(basha..'lock_spam'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الكلايش بالتأكيد تم قفلها \n✓'
else
redis:set(basha..'lock_spam'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل الكلايش \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'lock_spam'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الكلايش بالتأكيد تم فتحها \n✓'
else 
redis:del(basha..'lock_spam'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح الكلايش \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'lock_flood'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التكرار بالتأكيد تم قفله \n✓'
else
redis:set(basha..'lock_flood'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل التكرار \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'lock_flood'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التكرار بالتأكيد تم فتحه \n✓'
else 
redis:del(basha..'lock_flood'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح التكرار \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'lock_bots'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* البوتات بالتأكيد تم قفلها \n✓'
else
redis:set(basha..'lock_bots'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل البوتات \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'lock_bots'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* البوتات بالتأكيد تم فتحها \n✓'
else 
redis:del(basha..'lock_bots_by_kick'..msg.chat_id_)
redis:del(basha..'lock_bots'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح البوتات \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'lock_join'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الاضافه بالتاكيد تم قفلها \n✓'
else
redis:set(basha..'lock_join'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل الاضافه \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'lock_join'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الاضافه بالتاكيد تم فتحها \n✓'
else 
redis:del(basha..'lock_join'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح الاضافه \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'lock_markdown'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الماركدوان بالتاكيد تم قفله \n✓'
else
redis:set(basha..'lock_markdown'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل الماركدوان \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'lock_markdown'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الماركدوان بالتأكيد تم فتحه \n✓'
else 
redis:del(basha..'lock_markdown'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح الماركدوان \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'lock_webpage'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الويب بالتأكيد تم قفله \n✓'
else
redis:set(basha..'lock_webpage'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل الويب \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'lock_webpage'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الويب بالتأكيد تم فتحه \n✓'
else 
redis:del(basha..'lock_webpage'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح الويب \n✓'
end
end
---------------Mute Gif-------------------
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'mute_gif'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* المتحركه بالتأكيد تم قفلها \n✓'
else
redis:set(basha..'mute_gif'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل المتحركه \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'mute_gif'..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'mute_game'..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'mute_game'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الألعاب بالتأكيد تم فتحها \n✓'
else 
redis:del(basha..'mute_game'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح الألعاب \n✓'
end
end
---------------Mute Inline-------------------
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'mute_inline'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الانلاين بالتأكيد تم قفله \n✓'
else
redis:set(basha..'mute_inline'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل الانلاين \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'mute_inline'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الانلاين بالتأكيد تم فتحه \n✓'
else 
redis:del(basha..'mute_inline'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح الانلاين \n✓'
end
end
---------------Mute Text-------------------
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'mute_text'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الدرشه بالتأكيد تم قفلها \n✓'
else
redis:set(basha..'mute_text'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل الدردشه \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'mute_text'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الدردشه بالتأكيد تم فتحها \n✓'
else 
redis:del(basha..'mute_text'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح الدردشه \n✓'
end
end
---------------Mute photo-------------------
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'mute_photo'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الصور بالتأكيد تم قفلها \n✓'
else
redis:set(basha..'mute_photo'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل الصور \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'mute_photo'..msg.chat_id_)then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'mute_video'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الفيديو بالتأكيد تم قفلها \n✓'
else
redis:set(basha..'mute_video'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل الفيديو \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'mute_video'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الفيديو يال��أكيد تم فتحها \n✓'
else 
redis:del(basha..'mute_video'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح الفيديو \n✓'
end
end
---------------Mute Audio-------------------
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'mute_audio'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الصوت بالتأكيد تم قفله \n✓'
else
redis:set(basha..'mute_audio'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل الصوت \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'mute_audio'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الصوت بالتأكيد تم فتحه \n✓'
else 
redis:del(basha..'mute_audio'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح الصوت \n✓'
end
end
---------------Mute Voice-------------------
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'mute_voice'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* البصمات بالتأكيد تم قفلها \n✓'
else
redis:set(basha..'mute_voice'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل البصمات \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'mute_voice'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* البصمات بالتأكيد تم فتحها \n✓'
else 
redis:del(basha..'mute_voice'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح البصمات \n✓'
end
end
---------------Mute Sticker-------------------
...
if   redis:get(basha..'mute_sticker'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الملصقات بالتأكيد تم قفلها \n✓'
else
redis:set(basha..'mute_sticker'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل الملصقات \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'mute_sticker'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الملصقات بالتأكيد تم فتحها \n✓'
else 
redis:del(basha..'mute_sticker'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح الملصقات \n✓'
end
end
---------------Mute Contact-------------------
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'mute_contact'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* جهات الاتصال بالتأكيد تم قفلها \n✓'
else
redis:set(basha..'mute_contact'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل جهات الاتصال \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'mute_contact'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* جهات الاتصال بالتأكيد تم فتحها \n✓'
else 
redis:del(basha..'mute_contact'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح جهات الاتصال \n✓'
end
end
---------------Mute Forward-------------------
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'mute_forward'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التوجيه بالتأكيد تم قفلها \n✓'
else
redis:set(basha..'mute_forward'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل التوجيه \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'mute_forward'..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'mute_location'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الموقع بالتأكيد تم قفله \n✓'
else
redis:set(basha..'mute_location'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل الموقع \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'mute_location'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الموقع بالتأكيد تم فتحه \n✓'
else 
redis:del(basha..'mute_location'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح الموقع \n✓'
end
end
---------------Mute Document-------------------
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'mute_document'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الملفات بالتأكيد تم قفلها \n✓'
else
redis:set(basha..'mute_document'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل الملفات \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'mute_document'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الملفات بالتأكيد تم فتحها \n✓'
else 
redis:del(basha..'mute_document'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح الملفات \n✓'
end
end
---------------Mute TgService-------------------
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'mute_tgservice'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الاشعارات بالتأكيد تم قفلها \n✓'
else
redis:set(basha..'mute_tgservice'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل الاشعارات \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'mute_tgservice'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الاشعارات بالتأكيد تم فتحها \n✓'
else 
redis:del(basha..'mute_tgservice'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح الاشعارات \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'mute_keyboard'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الكيبورد بالتأكيد تم قفله \n✓'
else
redis:set(basha..'mute_keyboard'..msg.chat_id_,true)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم قفل الكيبورد \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'mute_keyboard'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* الكيبورد بالتأكيد تم فتحه \n✓'
else 
redis:del(basha..'mute_keyboard'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تم فتح الكيبورد \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'lock_bots_by_kick'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* البوتات بالطرد بالتاكيد تم قفله \n✓'
else
redis:set(basha..'lock_bots'..msg.chat_id_,true)
redis:set(basha..'lock_bots_by_kick'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'lock_bots_by_kick'..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(basha..'lock_pin'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التثبيت بالفعل مقفل \n✓'
else
redis:set(basha..'lock_pin'..msg.chat_id_,true) 
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تـم قفل التثبيت \n✓'
end
end
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(basha..'lock_pin'..msg.chat_id_) then
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* التثبيت بالفعل مفتوح \n✓'
else 
redis:del(basha..'lock_pin'..msg.chat_id_)
return '🙋🏼‍♂️*¦* أهلا عزيزي '..msg.TheRankCmd..'\n📡*¦* تـم فتح التثبيت   \n✓'
end
end
